...
const backupController = {
  ...
  async create(req, res) {
    try {
      ...
      // Подсчитываем количество записей для summary
const summary = {
  ...
  async restore(req, res) {
    try {
      ...
      try {
        ...
        // Порядок важен из-за foreign keys - сначала удаляем зависимые
        const deleteOrder = [
        ...
        for (const table of restoreOrder) {
          ...
          // Сбрасываем sequence для serial полей
          try {
            await client.query(`
